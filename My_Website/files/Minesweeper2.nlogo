...
to setup
  clear-all
  import-drawing "cbs.jpg"
  set clock 0
  set game-started? false
  set game-over? false
  set-default-shape grass-squares "flower"
  set-default-shape mines "bug"
  set-default-shape markers "turtle"
  ask patches [
    sprout-grass-squares 1 [ set color pink]
    set pcolor yellow
  ]
